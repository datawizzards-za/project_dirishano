...
if(isset($_SESSION['username'])){
    ...
    header("location:index.php?page_id=".urldecode($user));
}else{  
?>
<!DOCTYPE html>
<html lang="en">
		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="login.php#forgotpassModal"> Forgot Password?</a>
		                </span>
		            </label>
		            ...
		            <div class="registration">
		                ...
		                <a data-toggle="modal" href="login.php#registerModal">Register for Free</a>
		            </div>
		        </div>
                  </form>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row centered">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <h4><strong><a href="register-sp.php">SERVICE PROVIDER</a></strong></h4>
                                </div>
                                <div class="col-md-4 col-lg-4">
