	  ...
	  <div id="login-page">
	  	<div class="container">	  	
		        ...
		        <h2 class="form-login-heading">JMB Jobs Portal <br />Job Seeker Registration</h2>   
                        ...
                        <div id="loading" class="text-center animated bounceIn" hidden>
                            <br />
                            <img src="../images/preloader.gif" height="64" width="64" alt="">
                            <br />
                        </div>

                        <div id="error" class="col-lg-12 centered animated bounceIn" hidden>
                            <br />
                            <div id="error_msg" class="alert alert-danger text-center text-bold text-desc">                                
                            </div>                                                            
                        </div>

                        <div id="success" class='col-lg-12 centered animated bounceIn' hidden>
                            <br />
