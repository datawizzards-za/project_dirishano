...
function initRangeSlider(){
    var ids=["#sliderEx1","#sliderEx2","#sliderEx3","#sliderEx4","#sliderEx5","#sliderEx6","#sliderEx7"];ids.forEach(function(id){$(id).slider()})}function initDatepicker(){$("#datepickerDemo").datepicker({autoclose:!0}),$("#datepickerDemo1").datepicker({todayHighlight:!0})}function _init(){initSelect2(),initColorpicker(),initTextEditor(),initRangeSlider(),initDatepicker()}_init()});