    ...
    $("#uploadimage").on('submit',(function(e) {
        ...
        $.ajax({
            ...
            success: function(data)   // A function to be called if request succeeds
            {
                ...
                $('#pic_error').show(function()
                {
                    $("#error_msg").html("Oops. Invalid image type. <br>Only png and jpg images are permitted.");
                });               
            }else{
                $('#pic_error').show(function()
                {
                    $("#error_msg").html("Oops. Some technical error occured. <br>Please try again later.");
                });
            }
            },
            error: function(data)
