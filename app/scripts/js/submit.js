        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data === "0") {
                    ...
                    $('#error_div').show(function() {
                        $("#error_msg").html("Oops! <br> That email address is already registered. <br />Please reset your password and login.");
                    });
                }else if (data === "5") {
                    $('#error_div').show(function() {
                        $("#error_msg").html("Oops! <br> There is an account registered with that Tax Number. <br />Please contact support to sort this out.");
                    });
                }else if (data === "6") {
                    $('#error_div').show(function() {
                        $("#error_msg").html("Oops! <br> There is an account registered with that Company Registration Number. <br />Please contact support to sort this out.");
                    });
                } else if (data === "3") {
                    $('#error_div').show(function() {
                        $("#error_msg").html("Oops! Account could not be created. <br />Something went wrong. Please try again.");
